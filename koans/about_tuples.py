...
class AboutTuples(Koan):
    ...
    def test_tuple_constructor_can_be_surprising(self):
        # Tuple will iterate through this string turnng the string into a tuple.
        self.assertEqual(('S', 'u', 'r', 'p', 'r', 'i', 's', 'e', '!'), tuple("Surprise!"))

    def test_creating_empty_tuples(self):
        # Tuples can be created with or without the word tuple, but better intreperated with the work tuple included.
        self.assertEqual(() , ())
    ...
    def test_tuples_can_be_embedded(self):
        ...
        # You can place tuples inside of other tuples
    ...
    def test_tuples_are_good_for_representing_records(self):
        ...
        # The first item of the third record.
        self.assertEqual("Cthulu", locations[2][0])
        # The the third item of the second entry of the first record.
