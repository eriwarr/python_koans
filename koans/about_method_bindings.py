...
class AboutMethodBindings(Koan):
    #__self__ attribute is the class itself,
    # A method is a function that is available for a given object because of the object's type.
    ...
    def test_functions_can_have_inner_functions(self):
        # Created a get_fruit method and then set it equal the return of function
